...
2. **ระบุหมวดหมู่ (topic)**:
   ...
   - ข้อความทุกข้อความที่นำมาจัดกลุ่ม ต้องมี topic อย่างน้อย 1 รายการ และ ต้องมี subtopic อย่างน้อย 1 รายการ หากไม่สามารถระบุได้ ให้ละเว้นข้อความนั้นไป
...
prompt_template = """
# topic ของคำถามที่พบบ่อยในอดีต (FAQ) - ใช้เป็นตัวอย่างในการจัดกลุ่ม ต้องมีอย่างน้อย 1 รายการ:
{faq_topic}

# sub topic ของคำถามที่พบบ่อยในอดีต (FAQ) - ใช้เป็นตัวอย่างในการจัดกลุ่ม ต้องมีอย่างน้อย 1 รายการ:
{faq_subtopic}

# topic ของปัญหาที่พบบ่อยในอดีต (Issue) - ใช้เป็นตัวอย่างในการจัดกลุ่ม ต้องมีอย่างน้อย 1 รายการ:
{issue_topic}

# sub topic ของปัญหาที่พบบ่อยในอดีต (Issue) - ใช้เป็นตัวอย่างในการจัดกลุ่ม ต้องมีอย่างน้อย 1 รายการ:
{issue_subtopic}
